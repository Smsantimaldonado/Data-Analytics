...
UPDATE Cliente SET Nombre = 'Carlos' WHERE N_Cliente = 562;

-- Borrar los datos de una fila especificando un campo de la columna en la Tabla Cliente --
DELETE FROM Cliente WHERE N_cliente = 562;
...
SELECT N_Cliente, Nombre, Sexo FROM Cliente;

-- Realizar Consulta de la Tabla Cliente a detalle--
SELECT N_Cliente, Nombre, Sexo
FROM Cliente WHERE Nombre = 'Christian';
